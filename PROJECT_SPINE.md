...
1. **NEXT:** **BL-038B — CE expected-liability model / override / audit foundation.** **NOT STARTED.** Do **not** implement expected liability, Detailed Selling Costs, Hawthorn import, or a Hawthorn remap in this documentation slice. Keep P04 Draft. Do **not** Submit or Approve & Lock P04. Do **not** create P05. Do **not** Adopt UAT-CC-001. **BL-034D is BANKED** at `6d11491`. HD-001 banked at `19553dd`. Founding Product Principles recorded. **HD-001, HD-002, HD-008, HD-038-1/2/3 remain resolved.** Hawthorn Gardens is retained as a future client-chart known-answer UAT. Do **not** switch 5231 to TIME. Do **not** Save migrated Admin cost-code rows whose server `reporting_group` is absent from the local Commercial Structure catalog. Historic P01/P02/P03 `reporting_month` remains NULL. P04 remains Draft with `reporting_month` **2026-08**; 5231 adj **+£7,720** / accrual **£120**.
