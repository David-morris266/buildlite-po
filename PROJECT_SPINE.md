...
1. **NEXT:** **Bank BL-038E only after explicit approval.** Implementation, automated verification, controlled human UAT, and SELECT-only forensic verification pass. Do **not** silently start Hawthorn, Detailed Selling Costs, another slice, or a Hawthorn remap. Keep Test Site 1 P04 Draft; do not Submit or Approve & Lock it, create P05, or Adopt UAT-CC-001.
