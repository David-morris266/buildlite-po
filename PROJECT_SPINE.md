...
3. Deferred: Prelims landing UX — primary “Add Prelims line” form vs company-template / “Set up site Prelims” as primary setup path (see `CURRENT_STATE.md`).
