...
1. **NEXT:** **Bank BL-038C.** Implementation, human visual UAT, and SELECT-only post-UAT forensic have passed. Do **not** start BL-038D/038E, Detailed Selling Costs, Hawthorn import, or a Hawthorn remap. Keep Test Site 1 P04 Draft. Do **not** Submit or Approve & Lock P04. Do **not** create P05. Do **not** Adopt UAT-CC-001. **BL-038B is BANKED.**
