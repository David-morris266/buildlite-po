...
export function formatCvrRow(row) {
  return {
    ...
    uncommittedForecastLabel: formatCvrMoney(row.uncommittedForecast),
    systemForecastLabel: formatCvrMoney(row.systemForecast),
    expectedLiabilityLabel: formatCvrMoney(row.expectedLiability),
    vaExposureUpliftLabel: formatCvrMoney(row.vaExposureUplift),
    changeExposureLabel: formatCvrMoney(row.changeExposure),
...
export function formatCvrTotals(totals) {
  return {
    ...
    expectedLiabilityLabel: formatCvrMoney(totals.expectedLiability),
    vaExposureUpliftLabel: formatCvrMoney(totals.vaExposureUplift),
