...
async function buildWholeCvrCloseCandidate(options = {}) {
  ...
  return {
    ...
    snapshot: {
      ...
      sourceReadiness,
      forecastRevenue,
      securedRevenue: revenue.summary.securedRevenue == null ? null : roundMoney(revenue.summary.securedRevenue),
      remainingForecastRevenue: revenue.summary.remainingForecast == null ? null : roundMoney(revenue.summary.remainingForecast),
      plotsSold: revenue.summary.plotsSold == null ? null : Number(revenue.summary.plotsSold),
      plotsRemaining: revenue.summary.plotsRemaining == null ? null : Number(revenue.summary.plotsRemaining),
