/**
 * BL-033C — Inclusive calendar-month helpers.
 * V1: no partial-month proration. Mid-month dates occupy the whole calendar month.
...
function monthNumberFromSiteStart(siteStart, date) {
  const count = inclusiveCalendarMonthCount(siteStart, date);
  return count;
}

function suggestNextReportingMonth(previousReportingMonth) {
