...
| `011_development_revenue_settings.sql` | BL-032A: `development_revenue_settings` (additive). BANKED. Default recognition policy `completion`. Do not apply to `buildlite_clone` until a later explicit UAT. |
